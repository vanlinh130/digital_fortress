...
export default function Login() {
    return (
        <div className="flex h-screen">
            <div className="w-1/2 bg-[#0D0F10] text-white flex flex-col justify-center px-12">
                <h1 className="text-4xl font-semibold mb-6">
                    Hello, <span className="">Digital Fortress</span>
                </h1>
                <p className="mb-4 text-[#6F767E]">Log in to platform to start creating magic.</p>
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center">
                            ...
                            <span className="ml-2 text-sm text-[#6F767E]">Remember me</span>
                        </label>
